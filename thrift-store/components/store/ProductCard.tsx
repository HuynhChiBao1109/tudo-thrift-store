...
import { formatPrice, getConditionLabel, getConditionColor, calculateDiscount, cn } from '@/lib/utils';
    ...
    <Link href={`/store/products/${product.id}`} className={cn('group block', className)}>
      <div className="relative overflow-hidden rounded-xl bg-gray-50">
        ...
        <div className="aspect-[3/4] relative overflow-hidden">
          ...
          {/* Discount badge */}
          {discount > 0 && (
            <div className="absolute top-3 left-3 bg-[#06365b] text-white text-xs font-bold px-2 py-1 rounded-full">
              -{discount}%
            </div>
          )}
          ...
          <button
            ...
            className={cn(
              ...
              added
                ...
                : 'bg-[#06365b] text-white hover:bg-[#06365b]/90'
            )}
          >
        ...
        <div className="p-3">
          <div className="flex items-start justify-between gap-2">
            ...
            <span className={cn('text-[10px] px-2 py-0.5 rounded-full font-medium shrink-0', getConditionColor(product.condition))}>
              {getConditionLabel(product.condition)}
            </span>
          </div>

          <div className="flex items-center gap-2 mt-2">
            <span className="text-[#06365b] font-bold">{formatPrice(product.price)}</span>
