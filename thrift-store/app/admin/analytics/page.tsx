...
const COLORS = ['#06365b', '#3387c7', '#66a5d5', '#99c3e3', '#cce1f1'];
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
            ...
            {isLoading ? <Skeleton className="h-52" /> : (
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={stats?.revenueByMonth}>
                  ...
                  <Bar dataKey="revenue" fill="#06365b" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            )}
          </CardContent>
        ...
        {isLoading ? null : (
          <>
            <div className="bg-gradient-to-br from-[#06365b] to-[#3387c7] rounded-xl p-6 text-white">
              <p className="text-blue-200 text-sm font-medium">Avg. Order Value</p>
              <p className="text-3xl font-bold mt-1">{formatPrice((stats?.totalRevenue || 0) / (stats?.totalOrders || 1))}</p>
