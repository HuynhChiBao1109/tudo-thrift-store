  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-0.5">{data?.total || 0} registered customers</p>
      </div>
                  ...
                  <tr key={customer.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        <div className="w-9 h-9 rounded-full bg-[#06365b] flex items-center justify-center text-white text-sm font-bold">
                    ...
                    <td className="px-6 py-4 text-right font-bold text-[#06365b]">
